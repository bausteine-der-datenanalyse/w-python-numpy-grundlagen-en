...
![Storage of data in native Python](../skript/00-bilder/data_memory_list.svg){#fig-python_memory fig-alt="Sequential data is stored at random places in memory"}

In contrast, NumPy arrays and matrices are stored in contiguous blocks of memory, allowing for more efficient data access.

![Storage of data in NumPy](../skript/00-bilder/data_memory_numpy.svg){#fig-numpy_memory fig-alt="Sequential data is stored in a continuous memory block"}
...
All functions introduced here can be found in the (English) NumPy documentation: [Documentation](https://numpy.org/doc/)
